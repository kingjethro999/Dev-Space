...
export function UniversalNav() {
  ...
  return (
    <>
      <nav className="border-b border-border/50 bg-background/70 backdrop-blur-md sticky top-0 z-50">
        ...
        {/* Mobile Drawer */}
        {menuOpen && (
          <div className="block lg:hidden bg-background/95 backdrop-blur-md w-full border-t border-border/50 px-4 py-4 animate-in fade-in slide-in-from-top-4 z-10 shadow-xl">
      ...
      {/* Glow AI Chat - rendered OUTSIDE nav so fixed positioning works correctly */}
      <GlowAIChat />
    </>
  )
}
